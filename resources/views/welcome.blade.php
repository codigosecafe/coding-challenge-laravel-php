...
<body>
    ...
    <div id="world"></div>
    <div id="instructions">
        Pressione o mouse e arraste para ventilar<br />
        <span class="lightInstructions">O Leão concerteza vai adorar</span>
        <br /><br /><br /><br />
        Esse projeto foi criado para testar os conhecimentos em desenvolvimento de um API REST<br />
        então não me dei ao trabalho de criar algo para você ver aqui<br />
        acesse a pasta !POSTMAN lá tem coisas mais uteis para você... rsrsrsrss
    </div>

    <div id="credits">
        <p>Yakudoo on <a class="society6" href="https://codepen.io/Yakudoo/pen/YXxmYR" target="blank">codepen</a></p>
    </div>
            ...
            Lion = function() {
                ...
                for (var j = 0; j < 4; j++) {
                    for (var k = 0; k < 4; k++) {
                        ...
                        if ((j == 0 && k == 0) || (j == 0 && k == 3) || (j == 3 && k == 0) || (j == 3 && k ==
                            3)) {
