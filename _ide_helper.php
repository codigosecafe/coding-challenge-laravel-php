...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Quest\ServiceProvider::boot()
         * @param mixed $fields
         * @static 
         */ 
        public static function orderByFuzzy($fields)
        {
                        return \Illuminate\Database\Query\Builder::orderByFuzzy($fields);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function whereFuzzy($field, $value = null)
        {
                        return \Illuminate\Database\Query\Builder::whereFuzzy($field, $value);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function orWhereFuzzy($field, $value = null)
        {
                        return \Illuminate\Database\Query\Builder::orWhereFuzzy($field, $value);
        }
